...
<div class="card card-outline card-purple">
	<div class="card-header">
		<h3 class="card-title">Dạnh sách xe</h3>
		<div class="card-tools">
			<a href="?page=cabs/manage_cab" class="btn btn-flat btn-success btn-sm"><span class="fas fa-plus"></span>  Thêm xe mới</a>
		</div>
	</div>
	<div class="card-body">
						...
						<tr>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-info btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  		Hoạt động
				                    <span class="sr-only">Đổi điểm xuống</span>
				                  </button>
				                  <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item" href="?page=cabs/view_cab&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Xem</a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item" href="?page=cabs/manage_cab&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Sửa</a>
				                    <div class="dropdown-divider"></div>
