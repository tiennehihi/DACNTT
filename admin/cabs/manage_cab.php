...
<div class="card card-outline card-purple rounded-0">
	...
	<div class="card-body">
		<form action="" id="cab-form">
            ...
            <div class="form-group">
				<label for="category_id" class="control-label">Loại xe</label>
                <select name="category_id" id="category_id" class="custom-select select2">
                    ...
                    ?>
                    <option value="<?= $row['id'] ?>" <?= isset($category_id) && $category_id == $row['id'] ? "selected" : "" ?>><?= $row['name'] ?> <?= $row['delete_flag'] == 1 ? "<small>Xóa</small>" : "" ?></option>
                    <?php endwhile; ?>
                </select>
			</div>
			<div class="form-group">
				<label for="cab_reg_no" class="control-label">Biển sô #/Số đăng ký xe #</label>
			...
			<div class="form-group">
				<label for="cab_model" class="control-label">Model xe</label>
			...
			<div class="form-group">
				<label for="driver_contact" class="control-label">Liên hệ tài xế #</label>
			...
			<div class="form-group">
				<label for="driver_address" class="control-label">Địa hỉ tài xế</label>
			...
			<div class="form-group">
				<label for="password" class="control-label">Mật khẩu của tài xế</label>
				...
				<small class="text-muted"><i>Không điền gì nếu bạn không muốn thay đổi mật khẩu.</i></small>
			</div>
			<div class="form-group col-md-6">
				<label for="" class="control-label">Ảnh đại điện</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-success" form="cab-form">Lưu</button>
		<a class="btn btn-flat btn-danger" href="?page=cabs">Hủy</a>
	</div>
</div>
<script>
